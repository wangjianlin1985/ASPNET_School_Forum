		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" class="active"><a href="#newsListPanel" aria-controls="newsListPanel" role="tab" data-toggle="tab">网站新闻列表</a></li>
			    	<li role="presentation" ><a href="frontAdd.aspx" style="display:none;">添加网站新闻</a></li>
				</ul>
			  	<!-- Tab panes -->
				    				...
				    				<table class="table table-condensed table-hover">
				    					...
				    					<asp:Repeater ID="RpNews" runat="server">
 										...
 										<tr>
 											...
 											<td>
 												<a href="frontshow.aspx?newsId=<%#Eval("newsId")%>"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
 												<a href="#" onclick="newsEdit('<%#Eval("newsId")%>');" style="display:none;"><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
 												<a href="#" onclick="newsDelete('<%#Eval("newsId")%>');" style="display:none;"><i class="fa fa-trash-o fa-fw"></i>删除</a>
 											</td> 
 										</tr>
 										</ItemTemplate>
 										</asp:Repeater>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;网站新闻信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-9">
			    <textarea id="news_content_edit" name="news.content" rows="8" class="form-control" placeholder="请输入新闻内容"></textarea>
			 </div>
		  </div>
		  <div class="form-group">
