...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">校园交流网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <!--<li><a href="<%=basePath %>UserInfo/frontlist.aspx">学生</a></li>-->
                <li><a href="<%=basePath %>Teacher/frontlist.aspx">教师查询</a></li>
                <li><a href="<%=basePath %>PhotoInfo/frontlist.aspx">照片浏览</a></li>
                <!--<li><a href="<%=basePath %>PhotoClass/frontlist.aspx">照片分类</a></li>-->
                <li><a href="<%=basePath %>Journal/frontlist.aspx">论坛交流</a></li>
                <!--<li><a href="<%=basePath %>JournalClass/frontlist.aspx">日志分类</a></li>
                <li><a href="<%=basePath %>Comment/frontlist.aspx">评论</a></li>-->
                <li><a href="<%=basePath %>Leaveword/frontlist.aspx">用户留言</a></li>
                <li><a href="<%=basePath %>News/frontlist.aspx">网站新闻</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>PhotoInfo/frontUserAdd.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;发布照片</a></li>
                        <li><a href="<%=basePath %>PhotoInfo/frontUserList.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我发布的照片</a></li>
                        <li><a href="<%=basePath %>Journal/frontUserAdd.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;发布帖子</a></li>
                        <li><a href="<%=basePath %>Journal/frontUserList.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的帖子</a></li>
                        <li><a href="<%=basePath %>Leaveword/frontUserAdd.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/frontUserList.aspx"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的留言</a></li>
