...
namespace chengxusheji.Admin
{
    public partial class LeavewordList : System.Web.UI.Page
    {
        ...
        protected void BtnAllDel_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(HSelectID.Value.Trim()))
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "suess", "信息成功删除..", "LeavewordTeacherList.aspx");
                    }
                    else
                    {
        ...
        protected void RpLeaveword_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            if (e.CommandName == "Del")
            {
                try
                {
                    ...
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除成功...", "LeavewordTeacherList.aspx");
                    }
                    else
                    {
                        Common.ShowMessage.Show(Page, "seuss", "信息删除失败，请重试或联系管理人员...", "LeavewordTeacherList.aspx");
                    }
                }
                catch
                {
        ...
        {
            Response.Redirect("LeavewordTeacherList.aspx?leaveTitle=" + leaveTitle.Text.Trim()  + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&leaveTime=" + leaveTime.Text.Trim());
        }
