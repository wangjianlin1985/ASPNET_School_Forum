<%@ Page Language="C#" AutoEventWireup="true" CodeFile="M_EditCusInfo.aspx.cs" Inherits="WebSystem.Admin.M_EditCusInfo" %>
...
<body>
    <form id="form1" runat="server">
        <div class="div_All">
    <div class="Body_Title">客户信息管理 》》编辑客户</div>
        <hr />
